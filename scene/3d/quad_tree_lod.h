...
public:
	...
	void set_callbacks(const Callable &make_cb, const Callable &recycle_cb, const Callable &vbounds_cb);
	int get_lod_count();
	...
	void update(const Vector3 &view_pos);
	void debug_draw_tree(Object *ci);
...
private:
	...
	void _update(unsigned int quad_index, int lod, const Vector3 &view_pos);
