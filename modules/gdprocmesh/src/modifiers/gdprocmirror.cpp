...
void GDProcMirror::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_mirror_x", "p_mirror"), &GDProcMirror::set_mirror_x);
	ClassDB::bind_method(D_METHOD("get_mirror_x"), &GDProcMirror::get_mirror_x);
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "mirror_x", PROPERTY_HINT_RESOURCE_TYPE), "set_mirror_x", "get_mirror_x");

	ClassDB::bind_method(D_METHOD("set_mirror_y", "p_mirror"), &GDProcMirror::set_mirror_y);
	ClassDB::bind_method(D_METHOD("get_mirror_y"), &GDProcMirror::get_mirror_y);
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "mirror_y", PROPERTY_HINT_RESOURCE_TYPE), "set_mirror_y", "get_mirror_y");

	ClassDB::bind_method(D_METHOD("set_mirror_z", "p_mirror"), &GDProcMirror::set_mirror_z);
	ClassDB::bind_method(D_METHOD("get_mirror_z"), &GDProcMirror::get_mirror_z);
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "mirror_z", PROPERTY_HINT_RESOURCE_TYPE), "set_mirror_z", "get_mirror_z");

	ClassDB::bind_method(D_METHOD("set_duplicate", "p_mirror"), &GDProcMirror::set_duplicate);
	ClassDB::bind_method(D_METHOD("get_duplicate"), &GDProcMirror::get_duplicate);
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "duplicate", PROPERTY_HINT_RESOURCE_TYPE), "set_duplicate", "get_duplicate");
}
