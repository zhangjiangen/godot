...
void GDProcTransform::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_rotation", "p_pos"), &GDProcTransform::set_rotation);
	ClassDB::bind_method(D_METHOD("get_rotation"), &GDProcTransform::get_rotation);
	ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "rotation", PROPERTY_HINT_NONE, ""), "set_rotation", "get_rotation");

	ClassDB::bind_method(D_METHOD("set_translation", "p_translation"), &GDProcTransform::set_translation);
	ClassDB::bind_method(D_METHOD("get_translation"), &GDProcTransform::get_translation);
	ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "translation", PROPERTY_HINT_NONE, ""), "set_rotation", "get_rotation");

	ClassDB::bind_method(D_METHOD("set_scale", "p_scale"), &GDProcTransform::set_scale);
	ClassDB::bind_method(D_METHOD("get_scale"), &GDProcTransform::get_scale);
	ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "scale", PROPERTY_HINT_NONE, ""), "set_scale", "get_scale");
}
...
bool GDProcTransform::update(bool p_inputs_updated, const Array &p_inputs) {
	...
	if (updated) {
		...
		Basis *rots = memnew_arr(Basis, num_rotations);
