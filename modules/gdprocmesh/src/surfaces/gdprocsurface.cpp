...
void GDProcSurface::_bind_methods() {
}
...
String GDProcSurface::get_input_connector_name(int p_slot) const {
	switch (p_slot) {
		case ArrayMesh::ARRAY_VERTEX:
			return "vertices";
		case ArrayMesh::ARRAY_NORMAL:
...
String GDProcSurface::get_output_connector_name(int p_slot) const {
	return "surface";
}

Variant GDProcSurface::get_output(int p_slot) const {
	if (p_slot == 0) {
