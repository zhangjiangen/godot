...
void GDProcExtrudeShape::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_shape_is_closed", "p_shape_is_closed"), &GDProcExtrudeShape::set_shape_is_closed);
	ClassDB::bind_method(D_METHOD("get_shape_is_closed"), &GDProcExtrudeShape::get_shape_is_closed);
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "shape_is_closed", PROPERTY_HINT_NONE, ""), "set_shape_is_closed", "get_shape_is_closed");

	ClassDB::bind_method(D_METHOD("set_path_is_closed", "p_path_is_closed"), &GDProcExtrudeShape::set_path_is_closed);
	ClassDB::bind_method(D_METHOD("get_path_is_closed"), &GDProcExtrudeShape::get_path_is_closed);
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "path_is_closed", PROPERTY_HINT_NONE, ""), "set_path_is_closed", "get_path_is_closed");

	ClassDB::bind_method(D_METHOD("set_path_follow", "p_path_follow"), &GDProcExtrudeShape::set_path_follow);
	ClassDB::bind_method(D_METHOD("get_path_follow"), &GDProcExtrudeShape::get_path_follow);
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "path_follow", PROPERTY_HINT_NONE, ""), "set_path_follow", "get_path_follow");
}
...
String GDProcExtrudeShape::get_input_connector_name(int p_slot) const {
	if (p_slot == 0) {
		return "shape";
	} else if (p_slot == 1) {
		return "shape_is_closed";
...
String GDProcExtrudeShape::get_connector_property_name(int p_slot) const {
	if (p_slot == 1) {
		return "shape_is_closed";
	} else if (p_slot == 3) {
		return "path_is_closed";
...
String GDProcExtrudeShape::get_output_connector_name(int p_slot) const {
	return "Surface";
}

Variant GDProcExtrudeShape::get_output(int p_slot) const {
	if (p_slot == 0) {
