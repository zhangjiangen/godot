...
void GDProcSimplify::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_reduction", "p_reduction"), &GDProcSimplify::set_reduction);
	ClassDB::bind_method(D_METHOD("get_reduction"), &GDProcSimplify::get_reduction);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "reduction_factor", PROPERTY_HINT_NONE, ""), "set_reduction", "get_reduction");
}
...
String GDProcSimplify::get_input_connector_name(int p_slot) const {
	if (p_slot == 0) {
		return "surface";
	} else if (p_slot == 1) {
		return "reduction";
...
String GDProcSimplify::get_connector_property_name(int p_slot) const {
	if (p_slot == 1) {
...
String GDProcSimplify::get_output_connector_name(int p_slot) const {
	return "surface";
}

Variant GDProcSimplify::get_output(int p_slot) const {
	if (p_slot == 0) {
