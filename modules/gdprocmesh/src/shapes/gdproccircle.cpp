...
void GDProcCircle::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_radius", "p_radius"), &GDProcCircle::set_radius);
	...
	ClassDB::bind_method(D_METHOD("set_segments", "psegments"), &GDProcCircle::set_segments);
	ClassDB::bind_method(D_METHOD("get_segments"), &GDProcCircle::get_segments);
	ADD_PROPERTY(PropertyInfo(Variant::INT, "segments", PROPERTY_HINT_NONE, ""), "set_segments", "get_segments");
}
