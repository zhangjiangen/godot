...
void GDProcLine::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_vector", "p_vector"), &GDProcLine::set_vector);
	ClassDB::bind_method(D_METHOD("get_vector"), &GDProcLine::get_vector);
	ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "vector", PROPERTY_HINT_NONE, ""), "set_vector", "get_vector");

	ClassDB::bind_method(D_METHOD("set_segments", "p_segments"), &GDProcLine::set_segments);
	ClassDB::bind_method(D_METHOD("get_segments"), &GDProcLine::get_segments);
	ADD_PROPERTY(PropertyInfo(Variant::INT, "segments", PROPERTY_HINT_NONE, ""), "set_segments", "get_vector");
}
