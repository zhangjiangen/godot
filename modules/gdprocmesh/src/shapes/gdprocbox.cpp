...
void GDProcBox::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_width", "p_width"), &GDProcBox::set_width);
	ClassDB::bind_method(D_METHOD("get_width"), &GDProcBox::get_width);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "width", PROPERTY_HINT_NONE, ""), "set_width", "get_width");

	ClassDB::bind_method(D_METHOD("set_height", "p_height"), &GDProcBox::set_height);
	ClassDB::bind_method(D_METHOD("get_height"), &GDProcBox::get_height);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "height", PROPERTY_HINT_NONE, ""), "set_height", "get_height");

	ClassDB::bind_method(D_METHOD("set_depth", "p_depth"), &GDProcBox::set_depth);
	ClassDB::bind_method(D_METHOD("get_depth"), &GDProcBox::get_depth);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "depth", PROPERTY_HINT_NONE, ""), "set_depth", "get_depth");
}
...
String GDProcBox::get_input_connector_name(int p_slot) const {
	if (p_slot == 0) {
		return "width";
	} else if (p_slot == 1) {
		return "height";
...
String GDProcBox::get_connector_property_name(int p_slot) const {
	if (p_slot == 0) {
		return "width";
	} else if (p_slot == 1) {
		return "height";
...
String GDProcBox::get_output_connector_name(int p_slot) const {
	return "surface";
}

Variant GDProcBox::get_output(int p_slot) const {
