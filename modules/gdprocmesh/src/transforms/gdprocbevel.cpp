...
void GDProcBevel::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_distance", "p_distance"), &GDProcBevel::set_distance);
	ClassDB::bind_method(D_METHOD("get_distance"), &GDProcBevel::get_distance);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "distance", PROPERTY_HINT_NONE, ""), "set_distance", "get_distance");

	ClassDB::bind_method(D_METHOD("set_iterations", "p_iterations"), &GDProcBevel::set_iterations);
	ClassDB::bind_method(D_METHOD("get_iterations"), &GDProcBevel::get_iterations);
	ADD_PROPERTY(PropertyInfo(Variant::INT, "distance", PROPERTY_HINT_NONE, ""), "set_iterations", "get_iterations");

	ClassDB::bind_method(D_METHOD("set_is_closed", "p_is_closed"), &GDProcBevel::set_is_closed);
