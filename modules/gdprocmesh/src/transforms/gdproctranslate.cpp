...
void GDProcTranslate::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_translation", "p_translation"), &GDProcTranslate::set_translation);
	ClassDB::bind_method(D_METHOD("get_translation"), &GDProcTranslate::get_translation);
	ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "translation", PROPERTY_HINT_NONE, ""), "set_translation", "get_translation");
}
