...
void GDProcRedist::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_offset", "p_offset"), &GDProcRedist::set_offset);
	ClassDB::bind_method(D_METHOD("get_offset"), &GDProcRedist::get_offset);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "offset", PROPERTY_HINT_NONE, ""), "set_offset", "get_offset");

	ClassDB::bind_method(D_METHOD("set_strafe", "p_strafe"), &GDProcRedist::set_strafe);
	ClassDB::bind_method(D_METHOD("get_strafe"), &GDProcRedist::get_strafe);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "strafe", PROPERTY_HINT_NONE, ""), "set_offset", "get_offset");

	ClassDB::bind_method(D_METHOD("set_is_closed", "p_is_closed"), &GDProcRedist::set_is_closed);
	ClassDB::bind_method(D_METHOD("get_is_closed"), &GDProcRedist::get_is_closed);
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "is_closed", PROPERTY_HINT_NONE, ""), "set_is_closed", "get_is_closed");

	ClassDB::bind_method(D_METHOD("set_follow", "p_follow"), &GDProcRedist::set_follow);
	ClassDB::bind_method(D_METHOD("get_follow"), &GDProcRedist::get_follow);
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "follow", PROPERTY_HINT_NONE, ""), "set_follow", "get_follow");
}
...
String GDProcRedist::get_input_connector_name(int p_slot) const {
	if (p_slot == 0) {
		return "vectors";
	} else if (p_slot == 1) {
		return "offset";
...
String GDProcRedist::get_connector_property_name(int p_slot) const {
	if (p_slot == 1) {
		return "offset";
	} else if (p_slot == 2) {
		return "strafe";
...
String GDProcRedist::get_output_connector_name(int p_slot) const {
	if (p_slot == 0) {
		return "vectors";
	} else if (p_slot == 1) {
		return "rotations";
...
Variant GDProcRedist::get_output(int p_slot) const {
	if (p_slot == 0) {
