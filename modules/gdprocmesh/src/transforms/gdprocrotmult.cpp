...
void GDProcRotMult::_bind_methods() {
}
...
String GDProcRotMult::get_input_connector_name(int p_slot) const {
	if (p_slot == 0) {
		return "a";
	} else if (p_slot == 1) {
		return "b";
...
String GDProcRotMult::get_output_connector_name(int p_slot) const {
	return "values";
}

Variant GDProcRotMult::get_output(int p_slot) const {
