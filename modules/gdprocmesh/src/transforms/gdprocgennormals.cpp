...
void GDProcGenNormals::_bind_methods() {
}
...
String GDProcGenNormals::get_input_connector_name(int p_slot) const {
	if (p_slot == 0) {
		return "vertices";
	} else if (p_slot == 1) {
		return "indices";
...
String GDProcGenNormals::get_output_connector_name(int p_slot) const {
	return "normals";
}

Variant GDProcGenNormals::get_output(int p_slot) const {
