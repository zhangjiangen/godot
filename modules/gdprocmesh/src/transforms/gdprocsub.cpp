...
void GDProcSub::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_subtract", "p_subtract"), &GDProcSub::set_subtract);
	ClassDB::bind_method(D_METHOD("get_subtract"), &GDProcSub::get_subtract);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "subtract", PROPERTY_HINT_NONE, ""), "set_subtract", "get_subtract");
}
