...
void GDProcDiv::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_divider", "p_divider"), &GDProcDiv::set_divider);
	ClassDB::bind_method(D_METHOD("get_divider"), &GDProcDiv::get_divider);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "divider", PROPERTY_HINT_NONE, ""), "set_divider", "get_divider");
}
