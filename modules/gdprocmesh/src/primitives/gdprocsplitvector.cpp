...
void GDProcSplitVector::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_vector", "p_vector"), &GDProcSplitVector::set_vector);
	ClassDB::bind_method(D_METHOD("get_vector"), &GDProcSplitVector::get_vector);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "vectors", PROPERTY_HINT_NONE, ""), "set_vector", "get_vector");
}
