...
void GDProcExec::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_expression", "p_expression"), &GDProcExec::set_expression);
	ClassDB::bind_method(D_METHOD("get_expression"), &GDProcExec::get_expression);
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "expression", PROPERTY_HINT_NONE, ""), "set_expression", "get_expression");

	ClassDB::bind_method(D_METHOD("set_a", "p_a"), &GDProcExec::set_a);
	ClassDB::bind_method(D_METHOD("get_a"), &GDProcExec::get_a);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "expression", PROPERTY_HINT_NONE, ""), "set_a", "get_a");

	ClassDB::bind_method(D_METHOD("set_b", "p_b"), &GDProcExec::set_b);
	ClassDB::bind_method(D_METHOD("get_b"), &GDProcExec::get_b);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "b", PROPERTY_HINT_NONE, ""), "set_b", "get_b");

	ClassDB::bind_method(D_METHOD("set_c", "p_c"), &GDProcExec::set_c);
	ClassDB::bind_method(D_METHOD("get_c"), &GDProcExec::get_c);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "c", PROPERTY_HINT_NONE, ""), "set_c", "get_c");

	ClassDB::bind_method(D_METHOD("set_d", "p_d"), &GDProcExec::set_d);
	ClassDB::bind_method(D_METHOD("get_d"), &GDProcExec::get_d);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "d", PROPERTY_HINT_NONE, ""), "set_d", "get_d");

	ClassDB::bind_method(D_METHOD("set_e", "p_e"), &GDProcExec::set_e);
	ClassDB::bind_method(D_METHOD("get_e"), &GDProcExec::get_e);
	ADD_PROPERTY(PropertyInfo(Variant::REAL, "e", PROPERTY_HINT_NONE, ""), "set_e", "get_e");
}
