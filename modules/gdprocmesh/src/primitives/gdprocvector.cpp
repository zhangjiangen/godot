...
void GDProcVector::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_x", "p_x"), &GDProcVector::set_x);
	...
	ClassDB::bind_method(D_METHOD("set_y", "p_y"), &GDProcVector::set_y);
	...
	ClassDB::bind_method(D_METHOD("set_z", "p_z"), &GDProcVector::set_z);
